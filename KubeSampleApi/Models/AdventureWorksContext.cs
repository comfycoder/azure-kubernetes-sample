...
namespace KubeSampleApi.Models
{
    public partial class AdventureWorksContext : DbContext
    {
        ...
        public AdventureWorksContext(DbContextOptions<AdventureWorksContext> options, IConfiguration config)
            : base(options)
        {
            _config = config;
        }
        ...
        {
            var connectionString = _config["ConnectionStrings:SampleDB"];
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<SalesOrderHeader>(entity =>
            {
                ...
                entity.HasOne(d => d.Customer)
                    .WithMany(p => p.SalesOrderHeaderes)
                    .HasForeignKey(d => d.CustomerId)
                    .OnDelete(DeleteBehavior.ClientSetNull);
